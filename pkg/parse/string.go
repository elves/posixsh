// Code generated by "stringer -type=RedirMode,PrimaryType,SegmentType -output=string.go"; DO NOT EDIT.
...
func _() {
	...
	// Re-run the stringer command to generate them again.
	var x [1]struct{}
	_ = x[InvalidSegment-0]
	_ = x[StringSegment-1]
	_ = x[ExpansionSegment-2]
}

const _SegmentType_name = "InvalidSegmentStringSegmentExpansionSegment"

var _SegmentType_index = [...]uint8{0, 14, 27, 43}
